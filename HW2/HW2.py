...
def main():
    ...
    # 畫圖
    # plt.hist(H1.ravel(), bins=256, range=(0, 256), fc='b')
    # plt.plot(H1.ravel(), color='b')
    # plt.title("Area1")
    # plt.show()

    # plt.hist(H2.ravel(), bins=256, range=(0, 256), fc='b')
    # plt.plot(H2.ravel(), color='b')
    # plt.title("Area2")
    # plt.show()
    ...
    ax[1, 0].set_title('Area1 Histogram')
    ax[1, 0].plot(H1, color='b')
    ax[1, 1].set_title('Area2 Histogram')
